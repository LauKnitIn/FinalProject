...
public class PanelStart extends JPanel {
    ...
    private void addOptions() {
        ImageIcon informacionIcon = new ImageIcon("GUI-CLIENT_SIDE\\src\\co\\edu\\uptc\\resources\\informacion.png");
        ...
        btnMultijugador = addButton("Multijugador", 0, 500, e -> {
            ((View)(SwingUtilities.getWindowAncestor(PanelStart.this))).sendCommand("VALIDATE ");
            boolean isBusy = ((View)(SwingUtilities.getWindowAncestor(PanelStart.this))).isBusy();
            boolean isAdmin = ((View)(SwingUtilities.getWindowAncestor(PanelStart.this))).getIsAdmin();
            if (isBusy) {
                ((View)SwingUtilities.getWindowAncestor(PanelStart.this)).showPanelStart();
            }else{
                showPanelLoginName();
            }
        });
