...
public class DefeatRoundedButton extends JButton {

    private int cornerRadius;

    public DefeatRoundedButton(String text, int cornerRadius) {
        super(text);
        ...
        addMouseListener(new MouseAdapter() {
            ...
            public void mouseEntered(MouseEvent e) {
                setBackground(ColorPalette.COLOR_DEFEAT_MACK_MENU_BUTTON_HOVER);
            }

            @Override
            public void mouseExited(MouseEvent e) {
                setBackground(ColorPalette.COLOR_DEFEAT_BACK_MENU_BUTTON);
            }
        });
    }
