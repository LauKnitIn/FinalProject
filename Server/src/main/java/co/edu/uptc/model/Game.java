...
public class Game {
    ...
    public void configGame(Player p1) {
    ...
    public void configGame(Player p1, Player p2) {
        this.p1 = p1;
        this.p2 = p2;
        this.p1.setMaxAttempts(chosenDifficulty.getMaxAttempts());
        this.p2.setMaxAttempts(chosenDifficulty.getMaxAttempts());
        System.out.println("PLAYER 1 attempts: " + p1.getRemainingAttempts() + " p2RemAtempts: " + p2.getRemainingAttempts());
    }
    ...
    public boolean processGuess(char letter) {
        ...
        System.out.println(p1.getWordToGuess().getValue() + " <--PALABRA");
    ...
    public void isGameFinished(Player guessMaker) {
